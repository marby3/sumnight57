...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______  , S(KC_Z)  , S(KC_X)  , S(KC_C)  , S(KC_V)  , S(KC_B)  ,S(KC_RBRC),           S(KC_NUHS), S(KC_N)  , S(KC_M)  ,S(KC_COMM), S(KC_DOT),S(KC_SLSH),S(KC_RSFT),
                                    S(KC_LGUI), _______  , _______  , _______  ,            _______  , _______  , _______
  ),
  ...
  [2] = LAYOUT(
    ...
    _______  , _______  , KC_1     , KC_2     , KC_3     ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , KC_PGDN  , _______  , _______  , _______  , _______  , _______  ,
                                     KC_DOT   , _______  , _______  , _______  ,             KC_DEL  , _______  , _______
  ),
  ...
  [3] = LAYOUT(
    ...
    _______  , _______  , _______  , _______  , _______  , _______  , _______  ,            _______  , KC_HOME  , KC_PGDN  , KC_PGUP  , KC_END   , _______  , _______  ,
                                     KC_DOWN  , KC_UP    , KC_RGHT  , _______  ,            _______  , KC_BSPC  , _______
  ),
